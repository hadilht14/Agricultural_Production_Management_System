...
Farmer *Wilaya::findWinnerWilaya(const std::string &WilayaName, BinarySearchTree *product)
{
...
void Wilaya::PrintPesticides(string wilayaName, BinarySearchTree *product)
{
...
void Wilaya::PrintPinalitiesFarmersWilaya(string wilayaName, BinarySearchTree *product)
{
