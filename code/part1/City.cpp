...
Farmer *City::findWinnerCity(const std::string &cityName, BinarySearchTree *product)
{
...
void City::PrintPesticides(string CityName, BinarySearchTree *Product)
{
...
void City::PrintPinalitiesFarmersCity(string cityName, BinarySearchTree *product)
{
